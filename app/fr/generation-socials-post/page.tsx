...
export default function Page() {
  ...
  return (
    <PageView
      chatTitle={t(
        'fr.body.text.organize_chats_coming_soon_2760',
        'Organize chats (coming soon)'
      )}
      promptContent={t(
        'fr.body.text.welcome_area_will_let_you_organize_chats_v1_e24f',
      ...
      promptTime={t('fr.body.text.just_now_9b63', 'Just now')}
    />
  );
}
