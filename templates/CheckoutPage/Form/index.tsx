...
const Form = ({
  ...
  const plans = [
    { id: "0", title: monthlyLabel, value: 399 },
    { id: "1", title: yearlyLabel, value: 349, save: 20 },
  ];
  ...
  const onChange = (e: any) => {
    if (e.target && e.target.value && setCardNumber) {
      ...
      let newState = { mask: "9999-9999-9999-9999", value };
      if (/^3[47]/.test(value)) {
      ...
      <div className="mb-3 border border-n-3 rounded-xl dark:border-n-5">
        <div className="p-5">
          ...
          <div className="relative">
            <Icon className="absolute top-0 left-0 pointer-events-none fill-n-4/50" name="email" />
            <input
        ...
        <div className="p-5 border-t border-n-3 dark:border-n-5">
          ...
          <div className="flex md:flex-wrap">
            <div className="relative grow md:w-full md:mb-4">
              <Icon className="absolute top-0 left-0 pointer-events-none fill-n-4/50" name="credit-card" />
              <InputMask
                className={`${styleInput} pl-11`}
                {...cardNumber}
                type="tel"
