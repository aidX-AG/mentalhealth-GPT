                ...
                <div className="flex items-centerw-full max-w-[60.75rem] mx-auto lg:block">
                    <div className="grow pr-20 xl:pr-16 lg:pr-0">
                        ...
                        <div className="mb-6 h2 2xl:h3 xl:h4 lg:text-center">
                            {i18next.t("thanks.sections.title", { defaultValue: "Thank you for your purchase!" })}</div>
                        <div className="mb-8 body1 text-n-4 xl:body2 lg:text-center">
                            {i18next.t("thanks.sections.order-received", { defaultValue: "Your order has been received and is currently being processed. You will receive an email confirmation with your order details shortly." })}</div>
                        <div className="flex xl:block lg:flex lg:space-x-4 md:block md:space-x-0 md:space-y-3">
                            <Link
                                ...
                                href="/pricing"
                            >
                                {i18next.t("thanks.buttons.manage-subscription", { defaultValue: "Manage subscription" })}</Link>
                            <Link className="btn-blue xl:w-full" href="/">
                                {i18next.t("thanks.buttons.start-new-chat", { defaultValue: "Start new chat" })}</Link>
                        </div>
                    </div>
                    <Menu
