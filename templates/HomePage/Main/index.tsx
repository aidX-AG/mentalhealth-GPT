            ...
            <div className="grow px-10 py-20 overflow-y-auto scroll-smooth scrollbar-none 2xl:py-12 md:px-4 md:pt-0 md:pb-6">
                <div className="mb-10 text-center">
                    <div className="h3 leading-[4rem] 2xl:mb-2 2xl:h4">
                        {i18next.t("home.div_mentalhealth_gpt_01", { defaultValue: "mentalhealthGPT" })}</div>
                    <div className="body1 text-n-4 2xl:body1S">
                        {i18next.t("home.div_expertise_you_trust_privacy_you_02", { defaultValue: "Expertise you trust. Privacy you control. Science that empowers." })}</div>
                </div>
