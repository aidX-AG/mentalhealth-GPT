  ...
  return (
    <Layout hideRightSidebar>
      <div className="p-10 md:pt-5 md:px-6 md:pb-10">
        ...
        <div className="h3 leading-[4rem] md:mb-3 md:h3">{title}</div>
        <div className="mb-8 body1 text-n-4 md:mb-6 md:body1S">{subtitle}</div>

        <form className="mb-8" action="" onSubmit={() => console.log("Submit")}>
          <div className="relative">
            <button className="group absolute top-5 left-5 outline-none" type="submit">
              <Icon className="fill-n-4 transition-colors group-hover:fill-n-7" name="search" />
            </button>
            <input
        ...
        <div className="mb-11 h6 text-n-4 md:mb-6">{suggestedLabel}</div>
