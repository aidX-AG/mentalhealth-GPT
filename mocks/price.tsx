...
export const price = [{
  ...
  priceMonth: 0,
  priceYear: 0,
  priceDetails: t("Free forever"),
  details: [t("30 days history"), t("Up to 1000 messages/mo"), t("Limited AI capabilities")]
}, {
  id: "1",
  title: t("Pro"),
  colorTitle: "#3E90F0",
  ...
  details: [t("Email support"), t("Unlimited messages"), t("Access to AI capabilities")]
}, {
  id: "2",
  title: t("Enterprise"),
  colorTitle: "#3FDD78",
  ...
  priceMonth: 399,
  priceYear: 2399,
  priceDetails: t("Per month, per team members"), // (Tipp: “teaam” Tippfehler korrigiert)
  details: [t("Customizable AI models"), t("Advanced team management"), t("Enterprise-level support")]
}];
