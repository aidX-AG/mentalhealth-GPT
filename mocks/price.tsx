...
export function getPrice(t: (key: string) => string) {
  return [{
    id: "0",
    title: t("Starter"),
    popular: false,
...
export function getFeaturesPrice(t: (key: string) => string) {
  return [{
    id: "0",
...
export const price = getPrice(_);
export const featuresPrice = getFeaturesPrice(_);
