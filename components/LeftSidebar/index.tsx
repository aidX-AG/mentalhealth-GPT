'use client'; // Client-Komponente, da Hooks & Modals im Browser laufen
...
const LeftSidebar = ({
  ...
  // Einträge für die Navigation (linke Leiste, oberer Block)
  const navigation = [
    {
      title: t("Chats"),
      icon: "chat",
  ...
  const handleClick = () => {
    ...
    // Page scroll je nach Sidebar-Größe sperren/entsperren
  ...
  return (
    <>
      ...
      >
        ...
        {/* Scrollbereich: Navigation + Chatliste */}
        <div className="grow overflow-y-auto scroll-smooth scrollbar-none">
          <Navigation visible={value} items={navigation} />
          <div
            className={`my-4 h-0.25 bg-n-6 ${value ? "-mx-4 md:mx-0" : "-mx-2 md:mx-0"}`}
          />
          <ChatList visible={value} items={chatList} />
        </div>

        {/* Fußbereich: Profil + Theme-Toggle */}
