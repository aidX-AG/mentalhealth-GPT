'use client'; // ⬅️ Notwendig, weil die Komponente Hooks (useState/useEffect) nutzt und im Browser läuft.
...
// ✅ Stattdessen: useT() aus dem Transifex-React-Context.
// Der Context wird in app/TxClientProvider.tsx bereitgestellt.
...
const LeftSidebar = ({
  ...
  // ⬅️ Laufzeit-Übersetzer aus dem React-Context holen
  // Verhindert, dass die Komponente nach Hydration auf EN zurückspringt.
  const t = useT();
