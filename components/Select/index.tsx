      ...
      {({ open }) => (
        <>
          ...
          >
            ...
            <span className={twMerge("mr-auto truncate", small && "font-semibold")}>
              {value ? value.title : <span className="text-n-4">{placeholder}</span>}
            </span>

            <Icon
              className={twMerge(
                "shrink-0 ml-2 transition-transform dark:fill-n-1",
                open && "rotate-180",
                small && "ml-1",
                classArrow
              )}
          ...
          >
            <Listbox.Options
              className={twMerge(
                "absolute left-0 right-0 z-10 w-full mt-2 p-2 bg-n-1 rounded-lg shadow-[0_0_1rem_0.25rem_rgba(0,0,0,0.04),0_2rem_2rem_-1.5rem_rgba(0,0,0,0.1),inset_0_0_0_0.0625rem_#E8ECEF] outline-none dark:shadow-[0_0_1rem_0.25rem_rgba(0,0,0,0.04),0_2rem_2rem_-1.5rem_rgba(0,0,0,0.1),inset_0_0_0_0.0625rem_#343839] dark:bg-n-6",
                small && "right-auto mt-1 shadow-md",
                up && twMerge("top-auto bottom-full mt-0", small ? "mb-1" : "mb-2"),
                classOptions
              )}
            >
              {items.map((item) => (
                <Listbox.Option
                  ...
                  value={item}
                  className={twMerge(
                    "flex items-start p-2 rounded-lg base2 text-n-4 transition-colors cursor-pointer hover:text-n-7 ui-selected:!bg-n-3/50 ui-selected:!text-n-7 tap-highlight-color dark:hover:text-n-3 dark:ui-selected:!bg-n-7 dark:ui-selected:!text-n-1",
