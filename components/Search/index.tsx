        ...
        <form className="" action="" onSubmit={() => console.log("Submit")}>
            <div className="relative border-b border-n-3 dark:border-n-6">
                ...
                <input
                    ...
                    type="text"
                    name="search"
                    placeholder={i18next.t("common.placeholders.search", { defaultValue: "Search" })}
                    value={search}
                ...
                <div className="flex mb-5 md:block md:space-y-4 md:mb-0">
                    <div className="relative w-[10.31rem] mr-3 md:w-full md:mr-0">
                        ...
                        <input
                            ...
                            type="text"
                            name="search"
                            placeholder={i18next.t("common.placeholders.search-ellipsis", { defaultValue: "Search ..." })}
                            value={searchTitle}
                            onChange={(e: any) =>
                    ...
                    <Select
                        ...
                        icon="user-check"
                        placeholder={i18next.t("common.placeholders.created-by", { defaultValue: "Created by" })}
                    ...
                    <Select
                        ...
                        classArrow="dark:fill-n-4"
                        icon="clock"
                        placeholder={i18next.t("common.placeholders.date", { defaultValue: "Date" })}
                        items={dates}
                        value={date}
                        onChange={setDate}
                    />
