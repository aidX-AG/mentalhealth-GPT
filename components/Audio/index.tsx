...
const Audio = ({}: AudioProps) => {
    ...
    return (
        <div className="">
            <div className="mb-4">
                {i18next.t("common.div_your_audio_has_been_successfully_01", { defaultValue: "Your audio has been successfully generated. You may further customize it or simply download it for use." })}</div>
            <AudioPlayer edit={edit} onSave={() => setEdit(false)} />
            <div className="flex flex-wrap">
                <Actions
                    className="mr-4 mt-4 md:w-[calc(50%-0.5rem)] md:mr-2"
                    title={i18next.t("common.actionstitle_exporting_1_audio_06", { defaultValue: "Exporting 1 audio" })}
                    classButton="btn-dark md:w-full"
                    classTitle="pl-3"
                    buttonInner={
                        <>
                            <span>{i18next.t("common.fragment_export_02", { defaultValue: "Export" })}</span>
                            <Icon name="share" />
                        </>
                    }
                >
                ...
                >
                    <span>{i18next.t("common.button_edit_03", { defaultValue: "Edit" })}</span>
                    <Icon name="edit" />
                </button>
                <Select
                ...
                <Select
                    className="mr-4 mt-4 md:w-full md:mr-0"
                    title={i18next.t("common.selecttitle_speed_04", { defaultValue: "Speed" })}
                    items={speeds}
                    value={speed}
                    onChange={setSpeed}
                    small
                ...
                <div className="flex mr-4 mt-4 rounded-md shadow-[0_0.125rem_0.25rem_rgba(0,0,0,0.15)] bg-n-1 md:w-full md:mr-0 dark:bg-n-6 dark:shadow-[0_0.125rem_0.25rem_rgba(0,0,0,0.15),inset_0_0_0_0.0625rem_rgba(254,254,254,.1)]">
                    <Select
                        ...
                        title={i18next.t("common.selecttitle_voice_05", { defaultValue: "Voice" })}
                        items={genders}
                        value={gender}
                        onChange={setGender}
                        small
