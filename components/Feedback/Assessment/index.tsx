    ...
    <div className="py-3">
        <div className="table w-full">
            <div className="table-row caption1 text-n-4 md:flex">
                <div className="table-cell pl-5 py-2 md:hidden">{i18next.t("common.div_text_01", { defaultValue: "#" })}</div>
                <div className="table-cell pl-5 py-2 md:w-1/2 md:pr-2">
                    {i18next.t("common.div_incorrect_answer_5_02", { defaultValue: "Incorrect answer (5)" })}</div>
                <div className="table-cell pl-5 py-2 md:w-1/2 md:pl-0 md:pr-5">
                    {i18next.t("common.div_correct_answer_03", { defaultValue: "Correct answer" })}</div>
                <div className="table-cell pl-5 pr-5 py-2 text-center md:hidden">
                    {i18next.t("common.div_how_04", { defaultValue: "How" })}</div>
            </div>
            {items.map((x) => (
