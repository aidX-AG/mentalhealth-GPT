    ...
    <div className="flex items-center p-5 md:block">
        <div className="flex items-center mr-auto">
            ...
            <div className="grow pl-4">
                <div className="mb-1 h6">{i18next.t("common.div_very_good_01", { defaultValue: "Very good!" })}</div>
                <div className="flex items-center">
                    ...
                    <div className="ml-2 px-2 bg-n-3 rounded-lg base2 font-semibold text-n-7">
                        {i18next.t("common.div_485_02", { defaultValue: "4.85" })}</div>
                </div>
            </div>
        </div>
        <button className="btn-dark 2xl:w-12 2xl:p-0 2xl:text-0 md:w-full md:mt-4 md:text-[0.875rem]">
            <span>{i18next.t("common.button_download_03", { defaultValue: "Download" })}</span>
